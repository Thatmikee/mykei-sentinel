...
const ARTICLES = [
  ...
  { slug: 'surgeon-not-camera-200ms', issue: '03', tag: 'Technology', headline: 'A Surgeon, Not a Camera: The 200 Millisecond Rule', standfirst: 'The ADN responds in under 200ms. CCTV records a crime after it happens. There is no comparison worth making.' },
