...
const ROUTE_META = {
  '/': {
    ...
    description: 'Mykei Securities is developing hardware designed to make stolen goods harder to sell: shelf-level event detection, marker deployment, and Mykei Registry event records. Patent-pending, prototype stage.',
    canonical: 'https://mykei.io',
    ogTitle: 'Mykei Securities | Anti-Resale Crime and Asset Integrity',
    ogDescription: 'ADN is a patent-pending, prototype-stage system intended to link shelf-level event detection, marker deployment, and Mykei Registry records.',
    ogUrl: 'https://mykei.io',
    ogImage: 'https://mykei.io/social-share.png',
    twitterTitle: 'Mykei Securities | Anti-Resale Crime and Asset Integrity',
    twitterDescription: 'ADN is a prototype-stage system intended to protect high-loss shelves with event detection, marker deployment, and Mykei Registry records. No cameras.',
  },
  '/howitworks': {
    ...
    ogDescription: 'How ADN turns a defined shelf-level theft event into controlled marker deployment and a cartridge-linked registry record.',
  ...
  '/adn-1': {
    ...
    description: 'ADN is a patent-pending shelf-level retail defence device for high-loss categories, controlled marker deployment, and Mykei Registry event records.',
    ...
    twitterDescription: 'ADN links shelf theft events to controlled marker deployment and registry event records.',
  },
  '/pilot': {
  ...
  '/signal/surgeon-not-camera-200ms': {
    ...
    description: 'Mykei explains why ADN is designed around fast shelf-level event response rather than camera-based surveillance.',
...
const NOINDEX_ASSET_PATHS = new Set([
  ...
  '/Mykei_ADN_Pilot_Programme_Overview.pdf',
])
