...
export const blogPosts: BlogPostMeta[] = [
  {
    ...
    tags: ["ITV News", "shoplifting", "retail crime", "retail evidence", "ADN-1", "Mykei Registry", "Economic Sterilisation"],
  ...
  },
  {
    ...
    tags: ["Retail Crime Files", "February 2026", "BRC Crime Report", "retail theft", "resale economy", "ADN-1"],
  ...
  },
  {
    ...
    tags: ["Waitrose", "retail theft", "premium spirits", "smart cabinets", "resale economy", "ADN-1"],
  ...
  },
  {
    ...
    tags: ["SaferGems", "jewellery theft", "AI policing", "Metropolitan Police", "economic sterilisation", "ADN-1"],
  ...
  },
  {
    ...
    date: "2026-04-14",
    landmark: true,
    summary: "David Robinson told GMB that CCTV is security theatre. He was right. But nobody answered the follow-on question: if not cameras, then what? The ADN-1 is the answer.",
  ...
  },
  {
    ...
    date: "2026-03-28",
    summary: "£149 setup. £40/month. One stopped bulk sweep pays for the ADN-1 for an entire year. The unit economics of forensic retail defence, for BIRA members and independent retailers.",
  ...
  },
  {
    ...
    tags: ["Economic Sterilisation", "doctrine", "ADN-1"],
    readingTime: "7 min read",
  },
  {
    slug: "adn1-how-it-works",
    title: "How the ADN-1 Marks, Logs, and Flags Stolen Goods in Under Three Seconds",
    date: "2026-04-09",
    summary: "A walkthrough of the ADN-1 activation sequence: from sweep detection to controlled marker deployment to registry event record.",
    tags: ["ADN-1", "technology", "forensics"],
    readingTime: "6 min read",
  },
  {
  ...
  },
  {
    ...
    date: "2026-04-11",
    summary: "ADN-1 Independent Retail Pilot: what it tests, who it is for, and how to apply.",
    tags: ["pilot", "Manchester", "ADN-1"],
  ...
  },
  {
    ...
    date: "2026-04-12",
    landmark: true,
    summary: "The unit economics of the ADN-1 are built around the independent retailer's cash position, not the investor's return model. Here is how the numbers work.",
