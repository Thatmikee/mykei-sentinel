    ...
    <>
      ...
      <div className="mk-hero">
        ...
        <div className="mk-trust">
          {["Company No. 16984969", "Registered in England & Wales", "Manchester, UK", "Independent Retailers: Letters of Intent Signed", "Patent-pending: UK application No. 2606630.8"].map((item, i) => (
