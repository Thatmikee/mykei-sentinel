    ...
    >
      <defs>
        <linearGradient id="goldH" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%"   stopColor="#D8001F" />
          <stop offset="40%"  stopColor="#D8001F" />
          <stop offset="70%"  stopColor="#D8001F" />
          <stop offset="100%" stopColor="#D8001F" />
        </linearGradient>
      ...
      */}
      ...
      <polygon
        ...
        stroke="#D8001F" strokeWidth="2.5" fill="none"
        filter="url(#sk)"
      />
      ...
      {[0.25, 0.5, 0.75].map((t, i) => (
        <line key={i}
          ...
          stroke="#D8001F" strokeWidth="0.9" opacity="0.5"
          filter="url(#sk)"
        />
      ))}
      ...
      {Array.from({ length: 22 }, (_, i) => {
        ...
        return (
          <line key={i}
            ...
            stroke="#D8001F" strokeWidth="1.2" opacity="0.65"
            filter="url(#sk)"
          />
        );
      })}
      ...
      {/* Back verticals */}
      <line x1="20"  y1="120" x2="20"   y2="760" stroke="#D8001F" strokeWidth="2" filter="url(#sk)"/>
      <line x1="1260" y1="120" x2="1320" y2="180" stroke="#D8001F" strokeWidth="2" filter="url(#sk)"/>
      {/* Bottom rear */}
      <line x1="20"   y1="760" x2="80"   y2="820" stroke="#D8001F" strokeWidth="2" filter="url(#sk)"/>
      <line x1="1260" y1="760" x2="1320" y2="820" stroke="#D8001F" strokeWidth="2" filter="url(#sk)"/>
      <line x1="20"   y1="760" x2="1260" y2="760" stroke="#D8001F" strokeWidth="1.8" filter="url(#sk)" strokeDasharray="6,4"/>
      ...
      {[370, 530, 690].map((y, si) => (
        <g key={si} filter="url(#sk)">
          ...
          {/* Shelf board top */}
          <line x1="80"   y1={y-14} x2="1320" y2={y-14} stroke="#D8001F" strokeWidth="1.5" opacity="0.7"/>
          {/* Recede depth lines at ends */}
          <line x1="80"   y1={y} x2="20"   y2={y-14} stroke="#D8001F" strokeWidth="1.5" opacity="0.7"/>
          <line x1="1320" y1={y} x2="1260" y2={y-14} stroke="#D8001F" strokeWidth="1.5" opacity="0.7"/>
          {/* Shadow under shelf */}
          <line x1="80"   y1={y+6} x2="1320" y2={y+6} stroke="#D8001F" strokeWidth="2" opacity="0.45"/>
        </g>
      ))}
      ...
      {[540, 900].map((x, di) => (
        <g key={di} filter="url(#sk)">
          <line x1={x} y1="180" x2={x} y2="820" stroke="#D8001F" strokeWidth="2.2"/>
          {/* Receding top edge */}
          <line x1={x} y1="180" x2={x - 15} y2="120" stroke="#D8001F" strokeWidth="1.4" opacity="0.7"/>
        </g>
      ))}
      ...
      */}
        ...
        return (
          <g key={i} filter="url(#sk)">
            ...
            <rect x={x} y={y} width={w} height={h} rx="3"
              stroke="#D8001F" strokeWidth="2" fill="none"/>
            {/* Top label line */}
            <line x1={x+8} y1={y+9} x2={x+w-8} y2={y+9}
              stroke="#D8001F" strokeWidth="1.4"/>
            {/* Sensor circles */}
            <circle cx={x+14} cy={y+19} r="3.5"
              stroke="#D8001F" strokeWidth="1.5" fill="none"/>
            <circle cx={x+26} cy={y+19} r="3.5"
              stroke="#D8001F" strokeWidth="1.5" fill="none"/>
            {/* Text placeholder lines */}
            <line x1={x+36} y1={y+17} x2={x+w-8} y2={y+17}
              stroke="#D8001F" strokeWidth="1.2" opacity="0.9"/>
            <line x1={x+36} y1={y+22} x2={x+w-18} y2={y+22}
              stroke="#D8001F" strokeWidth="0.9" opacity="0.6"/>
            {/* Mount clip */}
      ...
      {[80, 1320].map((x, i) => (
        <g key={i} filter="url(#sk)">
          <line x1={x} y1="820" x2={x} y2="840" stroke="#D8001F" strokeWidth="3"/>
          <ellipse cx={x} cy="843" rx="22" ry="7"
            stroke="#D8001F" strokeWidth="1.8" fill="none"/>
        </g>
      ))}
    </svg>
  </div>
