...
const STATUS_CONFIG = {
  active:  { label: "IN PROGRESS", bg: "rgba(216,0,31,0.12)", border: "rgba(216,0,31,0.4)", color: "#D8001F", dot: "#D8001F" },
    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .rm-nav-brand-sub  { font-family: 'JetBrains Mono', monospace; font-size: 8px; letter-spacing: 2.5px; text-transform: uppercase; color: #D8001F; }
        ...
        .rm-nav-cta { font-size: 13px; font-weight: 600; color: #fff; background: #111318; padding: 8px 20px; border-radius: 6px; transition: all 0.2s; }
        .rm-nav-cta:hover { background: #D8001F; transform: translateY(-1px); box-shadow: 0 4px 16px rgba(216,0,31,0.3); }
        ...
        .rm-mobile-cta { font-size: 14px; font-weight: 700; color: #fff; background: #111318; padding: 12px; border-radius: 6px; text-align: center; margin-top: 8px; }

        /* HERO HEADER */
        .rm-header {
          background: #FFFFFF;
          background-image: radial-gradient(rgba(216,0,31,0.07) 1px, transparent 1px);
        ...
        .rm-eyebrow { font-family: 'JetBrains Mono', monospace; font-size: 9.5px; letter-spacing: 2.5px; text-transform: uppercase; color: #D8001F; margin-bottom: 14px; }
        ...
        .rm-progress-widget {
          ...
          border: 1px solid rgba(216,0,31,0.2);
          border-radius: 12px; padding: 24px 28px;
          min-width: 200px; text-align: center;
        }
        .rm-progress-pct { font-size: 42px; font-weight: 800; color: #D8001F; letter-spacing: -2px; line-height: 1; }
        ...
        .rm-progress-bar-fill { background: linear-gradient(90deg, #D8001F, #D8001F); border-radius: 100px; height: 4px; transition: width 1.2s ease; }
        ...
        .rm-flow-arrow.gold { border-left-color: #D8001F; }
        .rm-flow-line.gold { background: linear-gradient(90deg, #D8001F, #D8001F); }
        ...
        .rm-card.rm-card-selected {
          border-color: #D8001F;
          box-shadow: 0 8px 32px rgba(216,0,31,0.12), 0 0 0 1px rgba(216,0,31,0.15);
        }
              ...
              <>
                ...
                >
                  <div
                    ...
                    style={{
                      background: isSelected ? cfg.color : (isActive ? "rgba(216,0,31,0.08)" : "#f8f9fc"),
