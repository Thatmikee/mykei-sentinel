    ...
    <>
      ...
      <nav className={`b-nav${scrolled ? " up" : ""}`}>
        ...
        <div style={{ display: "flex", gap: 24, alignItems: "center" }}>
          ...
          <a href="/contact" style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 9, letterSpacing: 1.5, textTransform: "uppercase", color: scrolled ? INK : "#fff", border: `1px solid ${GOLD}`, padding: "7px 14px", transition: "color 0.25s" }}>
            Join Pilot
          </a>
        </div>
      </nav>
