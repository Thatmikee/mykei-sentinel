...
const TIMELINE = [
  ...
  { year: "2026", title: "Independent Retail Pilot opens · 5 signed LOIs", sub: "Greater Manchester · 2026 · Registry-first field validation", type: "founding" },
];
          ...
          <div className="fn-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "start" }}>
            <Reveal delay={0.1}>
              ...
              <p style={{ fontSize: 16, lineHeight: 1.85, color: "#555", marginBottom: 32 }}>
                Michael Esema identified that 94% of stolen goods are sold online. That means
