        ...
        <article style={{ maxWidth: 760, margin: "0 auto", padding: "0 32px 80px" }}>
          ...
          <Reveal>
            ...
            <p style={{ fontSize: 17, lineHeight: 1.9, marginBottom: 14 }}>
              The Mykei Registry doesn't wait for a report. When the ADN-1 fires and registers a batch code, that batch code is the bridge between the shelf and the resale channel. The intended pipeline: the registry cross-references listings, no human required. Mykei holds seventeen patent claims covering this architecture. What it means practically: the moment of marking is also the moment the goods become traceable across every channel they move through.
            </p>
            <p style={{ fontSize: 17, lineHeight: 1.9, marginBottom: 28 }}>
          ...
          <Reveal>
            ...
            <p style={{ fontSize: 17, lineHeight: 1.9, marginBottom: 28 }}>
              When an OCG calculates a target, they're calculating liquidation probability. That's it. What can we take, and what can we get for it. Push the liquidation probability toward zero and the target loses its value. Every shelf the ADN-1 covers changes that calculation. That's not a security feature. It's a change to the underlying economics of whether your store is worth hitting.
            </p>
          </Reveal>
          ...
          <Reveal>
            <div style={{ textAlign: "center", border: `1px solid ${RULE}`, borderRadius: 10, padding: "40px 32px", marginBottom: 48 }}>
              ...
              <p style={{ fontSize: 15, color: MID, lineHeight: 1.7, maxWidth: 480, margin: "0 0 28px" }}>Five slots. Founders pricing. £149 setup + £40/month. Full production hardware from day one.</p>
            ...
            <div style={{ borderTop: `1px solid ${RULE}`, paddingTop: 32, display: "flex", gap: 20, alignItems: "flex-start" }}>
              ...
              <div>
                ...
                <p style={{ fontSize: 14, lineHeight: 1.75, color: MID, margin: "0 0 10px" }}>
                  <strong style={{ color: INK }}>Michael Esema, MBA, MSc.</strong> Founder of Mykei Securities. I spent years in government financial audit and emergency budget management, then came to the UK and watched retail theft up close at B's Hive. The two experiences together made the structural failure impossible to ignore. I filed seventeen patent claims and built the ADN-1 to close it.
                </p>
