        ...
        <article style={{ maxWidth: 760, margin: "0 auto", padding: "0 32px 80px" }}>
          ...
          <Reveal>
            <div style={{ background: "#F8F8F6", border: `1px solid ${RULE}`, borderLeft: `3px solid ${GOLD}`, borderRadius: 10, padding: "24px 28px", marginBottom: 36, overflow: "auto" }}>
              <div style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 9, letterSpacing: "2px", textTransform: "uppercase", color: GOLD, marginBottom: 16 }}>ADN Firmware: Sensor Initialisation (Encrypted Logic Core / MicroPython)</div>
...
# Both sensors live, individually addressable`}</pre>
          ...
          <Reveal>
            ...
            <p style={{ fontSize: 17, lineHeight: 1.9, marginBottom: 28 }}>
              The security market has conditioned retailers to expect surveillance as the baseline. Cameras everywhere. Data everywhere. GDPR compliance handled by a policy document nobody reads. The ADN has no camera. No biometric capability. The only data it generates is kinetic: distance measurements, velocity vectors, timestamps, and the forensic event package that follows. There is no face. No gait. Nothing that connects to a person. A Time-of-Flight sensor physically cannot capture identifying information.
            </p>
            <p style={{ fontSize: 17, lineHeight: 1.9, marginBottom: 28 }}>
          ...
          <Reveal>
            <div style={{ textAlign: "center", border: `1px solid ${RULE}`, borderRadius: 10, padding: "40px 32px", marginBottom: 48 }}>
              ...
              <p style={{ fontSize: 15, color: MID, lineHeight: 1.7, maxWidth: 480, margin: "0 0 28px" }}>Five slots. Pricing scoped per pilot. Prototype-stage hardware, direct founding team support.</p>
