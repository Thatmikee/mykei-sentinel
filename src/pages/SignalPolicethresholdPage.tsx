  ...
  return (
    <>
      <PageSEO
        ...
        keywords="police shoplifting threshold UK, £200 theft threshold, shoplifting charges UK 2026, Liberal Democrats shoplifting data, retail theft police response, 1 in 5 shoplifting charge, economic sterilisation, independent retailer theft, ADN-1 Mykei Securities"
        ogType="article"
        ...
        <article style={{ maxWidth: 740, margin: "0 auto", padding: "64px 24px 100px" }}>
            ...
            <div style={{ background: WARM, border: `1px solid ${RULE}`, padding: "32px 32px", marginBottom: 48 }} className="article-key-takeaways">
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 14 }}>
                {[
                  ...
                  "The ADN-1 links theft-related shelf events to controlled marker deployment and a registry record, reducing resale confidence regardless of police capacity.",
                ].map((t, i) => (
          ...
          <Reveal>
            <div style={{ border: `1px solid ${GOLD}`, padding: "36px 32px", marginBottom: 64, textAlign: "center" }}>
              ...
              <a href="/pilot" style={{ background: GOLD, color: INK, padding: "14px 32px", fontFamily: "'JetBrains Mono',monospace", fontSize: 12, letterSpacing: "2px", textTransform: "uppercase", textDecoration: "none", fontWeight: 700, display: "inline-block" }}>Apply for a Pilot Place</a>
            </div>
          </Reveal>
