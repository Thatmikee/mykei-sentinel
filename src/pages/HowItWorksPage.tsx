...
const STEPS = [
  {
    ...
    text: "ADN watches the shelf zone for a defined theft pattern. It is looking for rapid movement across a group of products, not a face, a body, or a customer profile.",
  ...
  },
  {
    ...
    text: "If the trigger condition is met, ADN deploys a controlled marker through the front outlet. Marker selection is subject to supplier specification, SDS review, COSHH review, and store suitability.",
...
const FAQS = [
  ...
  {
    question: "Does ADN identify people?",
    answer: "No. ADN is designed around shelf events, not suspect identity. It does not use facial recognition, biometric identification, or a suspect database.",
  },
  {
...
function JsonLd() {
  const json = {
    ...
    "@graph": [
      {
        "@type": "TechArticle",
        headline: "How ADN works",
        description: "A plain language explanation of ADN, controlled marker deployment, and Mykei Registry event records.",
  ...
  return (
    <>
      <PageSEO
        ...
        keywords="how ADN works, Mykei Registry, retail theft prevention, forensic retail defence, controlled marker deployment, shelf level retail security, shoplifting prevention, organised retail crime, retail loss prevention, no camera retail security"
        breadcrumbs={[
      ...
      <style>{`
        ...
        .hiw-dot { width: 6px; height: 6px; border-radius: 50%; background: #D8001F; }
        .hiw-badge span {
          font-family: 'JetBrains Mono', monospace;
          font-size: 10px;
        ...
        .hiw-btn.primary { background: #111318; color: #ffffff; }
        .hiw-btn.secondary { background: #ffffff; color: #111318; border: 1px solid #d9dee8; }
        .hiw-h2 {
          margin: 0 0 18px;
          max-width: 760px;
          color: #1e1e1e;
        ...
        .hiw-card.dark .hiw-eyebrow { color: #D8001F; }
        ...
        .hiw-mini-flow span { color: #111318; font-weight: 700; font-size: 14px; line-height: 1.35; }
        ...
        .hiw-cta .hiw-btn.primary { background: #D8001F; color: #1e1e1e; }
      ...
      <main className="hiw-page">
        <section className="hiw-section hiw-hero">
          <div className="hiw-inner">
            <div className="hiw-badge"><span>Mykei Securities Ltd</span><i className="hiw-dot" /><span>How ADN works</span></div>
        ...
        <section className="hiw-section">
          <div className="hiw-inner">
            ...
            <p className="hiw-copy">A first time visitor should understand the loop in a few seconds. ADN is a shelf level event system. It turns a defined theft pattern into a physical marker and a structured record.</p>
        ...
        <section className="hiw-section">
          <div className="hiw-inner">
            ...
            <div className="hiw-mini-flow">
              ...
              <div><strong>Detect</strong><span>ADN recognises the defined shelf event</span></div>
        ...
        <section className="hiw-section">
          <div className="hiw-inner">
            <div className="hiw-eyebrow">Who This Is For</div>
            <h2 className="hiw-h2">For retailers who feel let down by conventional security.</h2>
            <ul style={{ listStyle: "none", padding: 0, margin: "24px 0 0", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
              {[
                ...
                <li key={text} style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
                  <span style={{ width: 18, height: 18, borderRadius: "50%", background: "rgba(216,0,31,0.15)", border: "1px solid rgba(216,0,31,0.4)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 9, flexShrink: 0, marginTop: 2 }}>✓</span>
                  <span>{text}</span>
                </li>
              ))}
            </ul>
            <div style={{ display: "flex", gap: 32, flexWrap: "wrap" as const, marginTop: 32 }}>
              {[
                { n: "Pre-pilot", l: "No pilot has started" },
                { n: "Under 1 hr", l: "Installation design target" },
              ].map(({ n, l }) => (
                <div key={n}>
                  <div style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 20, fontWeight: 700 }}>{n}</div>
                  <div style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 9, letterSpacing: "1px", textTransform: "uppercase" as const, marginTop: 4, opacity: 0.7 }}>{l}</div>
                </div>
              ))}
            </div>
          </div>
