      ...
      <main style={{ background: PAPER, minHeight: "100vh", paddingTop: 80 }}>
        ...
        <div style={{ paddingTop: 48, paddingBottom: 80 }}>
          ...
          <div style={section}>
            ...
            <p style={p}>
              Mykei Securities Ltd is a company registered in England and Wales (Company No. 16984969). Our registered address is 2 Princess Court, Butterstile Lane, Prestwich, Manchester, M25 9PW. We can be contacted at protocol@mykei.io.
            </p>
