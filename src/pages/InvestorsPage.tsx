...
export default function InvestorsPage() {
  useEffect(() => {
    ...
    if (desc) desc.setAttribute("content", "Investor relations for Mykei Securities Ltd. Market opportunity, traction, and use of funds for the ADN-1 forensic retail security system.");
        ...
        <section style={{ maxWidth: 880, margin: "0 auto", padding: "72px 40px", borderBottom: `1px solid ${RULE}` }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 40 }}>
            {[
              ...
              { stat: "5", label: "pilot partner slots open", note: "Greater Manchester, Q2 2026" },
        ...
        <section style={{ maxWidth: 880, margin: "0 auto", padding: "72px 40px", borderBottom: `1px solid ${RULE}` }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48 }}>
            <div>
              ...
              <p style={{ fontSize: 15, color: MUTED, lineHeight: 1.8, marginBottom: 16 }}>
                First: hardware production at scale. The current ADN-1 unit is hand-assembled for the pilot. Investment unlocks contract manufacturing, which reduces unit cost and enables a national rollout.
              </p>
              <p style={{ fontSize: 15, color: MUTED, lineHeight: 1.8 }}>
