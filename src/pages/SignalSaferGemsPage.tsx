  ...
  return (
    <>
      <PageSEO
        ...
        keywords="SaferGems jewellery theft 2026, armed robbery jewellery UK, Metropolitan Police jewellery crime, Surrey Police retail theft, ITV News jewellery robbery, UK government AI crime prediction, Concentrations of Crime Data Challenge DSIT, economic sterilisation jewellery, ADN forensic marking, SaferGems Q1 2026 report, DCI Scott Mather Metropolitan Police, jewellery theft surge UK"
        ogType="article"
        ldJson={JSON.stringify({
          ...
          "keywords": "SaferGems, jewellery theft, Metropolitan Police, Surrey Police, AI crime mapping, economic sterilisation, ADN",
          "mentions": [
            ...
            <div style={{ borderTop: `1px solid ${RULE}`, paddingTop: 32, display: "flex", gap: 20, alignItems: "flex-start" }}>
              ...
              <div>
                ...
                <p style={{ fontSize: 14, lineHeight: 1.75, color: MID, margin: "0 0 10px" }}>
                  <strong style={{ color: INK }}>Michael Esema</strong> is the founder of Mykei Securities and the inventor of Economic Sterilisation. He built the ADN forensic deployment module to address the structural failure of deterrence-based retail security. The Signal is his research publication.
                </p>
              </div>
            </div>
          </Reveal>
