...
const FACTS = [
  ...
  "Independent Retail Pilot: 2026, 5 signed retailer LOIs",
  "ADN-1 response time: under 3 seconds from detection to deployment",
  "Founders pricing: £149 setup + £40 per month",
...
export default function PressPage() {
  useEffect(() => {
    ...
    if (desc) desc.setAttribute("content", "Press kit for Mykei Securities Ltd: founder bio, company facts, logos, and media contact. ADN-1 forensic retail security. Manchester, UK.");
  ...
  return (
    <>
      <PageSEO
        title="Press Kit | Mykei Securities Ltd — ADN-1 Forensic Retail Security"
        description="Press resources for Mykei Securities Ltd: founder biography, company fact sheet, product overview, logos, and media contact. ADN-1 forensic retail defence. Manchester, UK. Company No. 16984969."
        canonical="https://mykei.io/press"
        keywords="Mykei Securities press kit, Michael Esema biography, ADN-1 press, retail security media, economic sterilisation press"
      />
      <SimpleNav />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48 }}>
            <div>
              ...
              <p style={{ fontSize: 15, color: MUTED, lineHeight: 1.8, marginBottom: 16 }}>
                Michael Esema is the founder and CEO of Mykei Securities Ltd. He invented the ADN-1 Active Forensic Defence Node, a shelf-mounted IoT device that detects bulk-sweep theft events, triggers controlled marker deployment, and logs cartridge-linked activations in the Mykei Registry.
              </p>
              <p style={{ fontSize: 15, color: MUTED, lineHeight: 1.8, marginBottom: 16 }}>
              ...
              <p style={{ fontSize: 15, color: MUTED, lineHeight: 1.8, marginBottom: 16 }}>
                Before founding Mykei, Michael progressed from Head Accountant to Assistant Manager at B's Hive, where he developed an operational understanding of the financial toll retail theft places on independent businesses. That direct experience shaped every design decision in the ADN-1.
              </p>
              <p style={{ fontSize: 15, color: MUTED, lineHeight: 1.8 }}>
                He holds an MSc from Manchester Metropolitan University (2024, Merit), an MBA from the Nigerian Defence Academy (2022), and a BSc from Benson Idahosa University (2018). He is a Lean Six Sigma practitioner, a Level 7 Project Management Advanced Diploma holder, and a recipient of the NUASA Most Auspicious Male Award. The Independent Retail Pilot is open for review in 2026.
              </p>
            </div>
            <div>
        ...
        <section style={{ maxWidth: 880, margin: "0 auto", padding: "72px 40px 96px" }}>
          ...
          <div style={{ maxWidth: 480 }}>
            ...
            <p style={{ fontSize: 15, color: MUTED, lineHeight: 1.8, marginBottom: 24 }}>
              We aim to respond to media enquiries within 24 hours. For interview requests, comment on retail crime data, or access to the ADN-1 technical specification, contact the press team directly.
            </p>
