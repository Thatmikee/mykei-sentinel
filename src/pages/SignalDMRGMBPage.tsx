  ...
  return (
    <>
      <PageSEO
        ...
        description="David Robinson told GMB that CCTV is security theatre. He was right. But the question he didn't answer is: what replaces it? Michael Esema on the forensic digital twin, Economic Sterilisation, and why the ADN-1 was built in a Prestwich workshop, not a venture capital portfolio."
        ...
        keywords="David Robinson GMB CCTV, retail security theatre, CCTV ineffective shoplifting, ADN-1 forensic retail defence, economic sterilisation, independent retailer security UK, controlled marker deployment, Mykei Securities, Independent Retail Pilot, forensic digital twin retail"
        breadcrumbs={[
      ...
      <div style={{ fontFamily: "'Georgia',serif", background: "#fff", color: INK, minHeight: "100vh" }}>
        ...
        <article style={{ maxWidth: 760, margin: "0 auto", padding: "0 32px 80px" }}>
          ...
          <Reveal>
            ...
            <p style={{ fontSize: 17, lineHeight: 1.9, marginBottom: 28 }}>
              When the ADN-1 activates, two things happen simultaneously. The 113kHz deployment module deploys a forensic marker compound designed to bond to whatever it contacts. The marker is invisible to the naked eye, visible under UV light, and designed to support evidential workflows. Each deployment carries a unique batch code tied to the store, the shelf position, and a millisecond timestamp.
            </p>
            <p style={{ fontSize: 17, lineHeight: 1.9, marginBottom: 28 }}>
              That batch code hits the Mykei Registry in real time. The registry holds a tamper-aware, batch-linked event record: store, shelf position, timestamp, and forensic marker ID. The item carries the marker. This is what I mean by a forensic digital twin: every theft event creates a traceable record that follows the goods, not just the shop floor. That record supports investigation, insurer review, and resale disruption workflows.
            </p>
            ...
            <div style={{ border: `1px solid ${RULE}`, borderRadius: 8, padding: "24px", marginBottom: 32, background: WARM }}>
              ...
              <div style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 11, color: MID, lineHeight: 1.65 }}>
                ADN-1 activation sequence: sweep detection (ToF sensor array) &rarr; kinetic signature classification (Encrypted Logic Core, &lt;50ms) &rarr; deployment module trigger (113kHz ultrasonic deployment module) &rarr; cloud registry update (TIR batch write) &rarr; batch-linked event record created. Total latency: under 200ms from sweep onset to registry record.
              </div>
            </div>
          </Reveal>

          <Reveal>
            <h2 style={{ fontSize: 24, fontWeight: 700, letterSpacing: "-0.5px", color: INK, margin: "40px 0 16px" }}>What CCTV cannot do. What ADN-1 does.</h2>
            ...
            <p style={{ fontSize: 17, lineHeight: 1.9, marginBottom: 28 }}>
              The ADN-1 marks the goods. The goods go wherever they go. When they surface on Vinted three days later, the TIR flags them. When a buyer meets the seller and hands over cash, the goods still carry the marker. The marker is not peelable. It is not washable with household products. It is a permanent forensic record of the theft event, carried by the stolen goods themselves.
            </p>
            <p style={{ fontSize: 17, lineHeight: 1.9, marginBottom: 28 }}>
              Robinson called cameras theatre. The reason cameras are theatre is that they produce evidence with no reliable chain of consequence attached to it. The ADN-1 produces evidence that travels with the crime. That is a different category of system entirely.
            </p>
          </Reveal>
            ...
            <div style={{ background: WARM, border: `1px solid ${RULE}`, borderRadius: 10, padding: "28px 32px", marginBottom: 40 }}>
              ...
              <ul style={{ padding: 0, margin: 0, listStyle: "none" }}>
                {[
                  ...
                  "The ADN-1's forensic digital twin links theft-related shelf events to marker and registry records.",
