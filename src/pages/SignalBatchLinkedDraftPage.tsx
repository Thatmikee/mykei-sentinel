  ...
  return (
    <article style={{ maxWidth: 720, margin: "0 auto", padding: "80px 24px", fontFamily: "'Sora', sans-serif", color: "#1E1E1E", lineHeight: 1.8 }}>
      ...
      <p style={{ fontSize: 16, color: "#4A3520", marginBottom: 32, fontStyle: "italic" }}>
        Mykei is refining ADN-1 around a batch-linked evidence model. The doctrine remains Economic Sterilisation. The deployment strategy now recognises two routes: independent retail validation and strategic retail pilots.
      </p>
      ...
      <p>
        ADN-1 was designed from the start to create that connection automatically. Detection triggers marking. Marking triggers registration. Registration creates a timestamped, batch-linked event record that connects the physical marker on a stolen item to the specific device, store, time, and forensic batch reference that created it.
      </p>
      <p>
      ...
      <p>
        ADN-1 closes that gap. Each activation records the device ID, the store reference, the event timestamp, the activation type, and the forensic batch reference. Every liquid batch is unique. Every deployment is tied to that batch. Every batch is tied to that retailer's registry account.
      </p>
      <p>
      ...
      <p>
        That doctrine applies at two scales. The first is independent retail validation, where ADN-1 is deployed in individual shops to prove detection accuracy, registry logging, and non-confrontational deterrence in real environments.
      </p>
      <p>
      ...
      <div style={{ marginTop: 40, padding: "24px 28px", background: "#FFFFFF", borderLeft: "3px solid #D4AF37" }}>
        ...
        <ul style={{ margin: 0, padding: "0 0 0 20px" }}>
          ...
          <li>ADN-1's batch-linked event model connects device ID, timestamp, store reference, event type, and forensic batch reference automatically.</li>
